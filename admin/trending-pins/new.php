<?php
    ...
    {
        $sql = 'INSERT INTO trending_pins (title, user_id, category_id, lat, lon, address, note)
                VALUES (
                "'. $_POST['title'] .'",
                "'. $_POST['user_id'] .'",
                "'. $_POST['category_id'] .'",
        ...
        ?>
        <script>
            alert('New Trending Pin Created Successfully');
	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-lg-10">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo HOST ?>admin/trending-pins/">Pins</a></li>
                ...
                <div class="ibox-content">
                    ...
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Select Trending Place</label>
                            <div class="col-sm-10">
