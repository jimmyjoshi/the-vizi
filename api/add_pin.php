<?php
    ...
    if ($ret['message'] == '') {
        ...
        $db->query('INSERT INTO pins(title, user_id, category_id, lat, lon, address, note) VALUES(:title, :user_id, :category_id, :lat, :lon, :address, :note)', $ins);
        ...
        $ret['message'] = 'Pin created successfully';
        $ret['status'] = 'success';
        $ret['data'] = $ins;
    }
